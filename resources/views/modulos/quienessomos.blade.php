...
<div class="container  my-5">
    ...
    <div class="row">
        <div class="col-6 bg-warning rounded-3">
            <h6><b>MISION</b></h6>
            <p>
        ...
        <div class="col-6">
            <center> <img src="{{ asset('img/logo-slogan.png') }}" class="img-thumbnail" alt="..."></center>
        </div>
    ...
    <div class="row">
        <center>
            <div class="col-12">
                <h4>Facebook</h4>
                <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D100068689404036&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
            </div>
    </div>
    </center>
    @endsection
